    ...
    switch (event?.type) {
      case 'checkout.session.completed':
        ...
        // else if (stripeObject?.mode === 'subscription') {
          //   await handleSubscriptionSuccess(stripeObject);
          // }
        break;
      ...
      case 'invoice.payment_failed':
        // This is for subscription payment failed
      ...
      case 'payment_intent.payment_failed':
        if(stripeObject.invoice){
          // invoice payment failed will handle by invoice.payment_failed
          break;
        }
        // This is for one time payment failed
